...
const CONFIG = {
    ...
    PROXIO_HERO_TITLE_2: '「好好宇宙」是一个精心策展的社群，专为那些在各自领域独立思考、积极创造的创业者、艺术家和专业人士而设。我们相信，最有价值的链接并非源于偶然，而是源于共享的价值观和精心营造的环境。因此，我们致力于打造一个能激发深度对话、促进有意义合作，并能在高压都市生活中滋养身心的“第三空间”。在这里，工作与生活、商业与艺术、独处与社交的界限被重新定义，只为给您带来最高品质的体验。', // 英雄区文字
    // 英雄区两个按钮，如果TEXT留空则隐藏按钮
    PROXIO_HERO_BUTTON_1_TEXT: '加入好好宇宙', // 英雄区按钮
    ...
    PROXIO_FAQS: [
        { q: '好好宇宙无限俱乐部”到底是什么？', a: '好好宇宙无限俱乐部是一家位于东京新宿，为独立的创业者、创造者和专业人士打造的新型态都市沙龙。我们融合了日间的精品共创空间与夜晚的策展式酒吧，致力于构建一个高品质、有深度的社群。这里不仅是工作的场所，更是激发灵感、拓展人脉、滋养身心的策展式社区。' },
        { q: '这里主要吸引什么样的人？', a: '我们欢迎那些正在积极地创造自己事业、并追求高品质生活方式的人，包括：正在打造自己的产品或品牌创业者与独立开发者；自由职业者与设计师：如作家、设计师、顾问等领域的专业人士；寻求灵感碰撞与展示机会的独立艺术家和创意人；对新商业与文化有敏锐洞察力的各界人士。' },
        { q: '这里的日间和夜间模式有什么不同？', a: '我们的运营模式是双重的：日间（11:00-17:00）：精品共创空间。** 对外开放，实行时间计费制。您可以在这里享受高速网络、精品咖啡、安静的工作区，并参加我们策划的共创活动、技能工作坊或疗愈课程。夜间（18:30-22:30）：策展式酒吧。** 氛围会转换为一个私密、高雅的酒吧。我们提供精选的酒水单，并时常举办品鉴会、沙龙讲座或小型艺术派对。为保证体验，晚间我们推荐您提前预定。' },
        { q: '我必须成为会员才能来吗？', a: '不一定，但会员体验是独一无二的。非会员：您可以随时在白天按时付费使用共创空间，或在晚上预定我们的酒吧座位。会员：成为会员，意味着您从“访客”转变为“社群核心成员”。会员身份是我们社群的基石，也是您获得最完整体验的方式。' },
    ],
